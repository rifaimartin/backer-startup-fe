<template>
  <div class="container mx-auto h-screen flex justify-center items-center">
    <div class="w-full lg:w-1/3 px-10 lg:px-0">
      ...
      <div class="mb-4 mt-6">
        <div class="mb-3">
          <button :disabled="selectedFiles == undefined" @click="upload" :class="selectedFiles == undefined ? 'opacity-50 cursor-not-allowed' : ''"
    ...
    methods: {
      ...
      async upload(file) {
        ...
        try {
          ...
          console.log("🚀 ~ file: upload.vue ~ line 62 ~ upload ~ response", response)
          this.$router.push({
            path: '/register-success'
          })
        } catch (error) {
          console.log("🚀 ~ file: upload.vue ~ line 64 ~ upload ~ error", error)
        }
      }
    }
  }

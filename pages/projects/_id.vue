    ...
    <section class="container project-container mx-auto -mt-56">
      <div class="flex mt-3">
        <div class="w-3/4 mr-6">
          ...
          <div class="flex -mx-2">
            <div v-for="image in campaign.data.images" :key="image.image_url"
              ...
              <figure class="item-thumbnail">
                <img :src="$axios.defaults.baseURL + '/' + image.image_url"
                  @click="changeImage($axios.defaults.baseURL + '/' + image.image_url)" alt=""
      ...
      <div class="flex justify-between items-center">
        <div class="w-full md:w-3/4 mr-6">
          ...
          <div class="flex progress-info mb-6">
            ...
            <div class="ml-auto font-semibold text-2xl">Rp
              {{ new Intl.NumberFormat().format(campaign.data.goal_amount)}}</div>
          </div>

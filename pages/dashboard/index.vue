  ...
  <div class="project-page">
    ...
    <section class="container mx-auto pt-8">
      ...
      <div class="block mb-2">
        <div class="w-full lg:max-w-full lg:flex mb-4" v-for="campaign in campaigns.data.data" :key="campaign.id">
          <div
...
<script>
  export default {
    ...
    async asyncData({
      ...
      console.log("🚀 ~ file: index.vue ~ line 82 ~ campaigns", campaigns)

  ...
  <div class="project-page">
    ...
    <section class="container mx-auto pt-8">
      <div class="flex justify-between items-center mb-6">
        <div class="w-3/4 mr-6">
          ...
          <ul class="flex mt-2">
            ...
            <li class="mr-6">
              <nuxt-link class="text-gray-800 font-bold" to="/dashboard/transactions">
                Your Transactions
              </nuxt-link>
            </li>
          </ul>
      ...
      <div class="block mb-2">
        <div class="w-full lg:max-w-full lg:flex mb-4" v-for="transaction in transactions.data.data" :key="transaction.id">
          <div
...
<script>
  export default {
    ...
    async asyncData({
      ...
      console.log("🚀 ~ file: index.vue ~ line 82 ~ transactions", transactions)

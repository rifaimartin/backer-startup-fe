      ...
      <div class="flex justify-between items-center">
        <div class="w-3/4 mr-6">
          <h3 class="text-2xl text-gray-900 mb-4">
            Edit Campaign "{{ campaign.data.data.name }}"
          </h3>
        </div>
              ...
              <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                  ...
                  <input
                    ...
                    v-model="campaign.data.data.name"
                  />
                </div>
                <div class="w-full md:w-1/2 px-3">
                  ...
                  <input
                    ...
                    v-model.number="campaign.data.data.goal_amount"
                  />
                </div>
                <div class="w-full px-3">
                  ...
                  <input
                    ...
                    v-model="campaign.data.data.short_description"
                  />
                </div>
                <div class="w-full px-3">
                  <label
                  ...
                  <input
                    ...
                    v-model="campaign.data.data.perks"
                  />
                </div>
                <div class="w-full px-3">
                  <label
                  ...
                  <textarea
                    ...
                    v-model="campaign.data.data.description"
                  ></textarea>
                </div>
              </div>
            </form>
